...
@dataclass
class MCMCHasInverseDepthMetrics(MCMCMetrics):
    ...
    def instantiate(self, *args, **kwargs) -> "MCMCHasInverseDepthMetricsModule":
        return MCMCHasInverseDepthMetricsModule(self)


class MCMCHasInverseDepthMetricsModule(MCMCMetricsImpl):
    config: MCMCHasInverseDepthMetrics
